        ...
        try:
            try:
                ...
                try:
                    ...
                    common.log("BaseCursor.request",  "%s - %s"%(Exception,str(msg)), xbmc.LOGERROR )
                except:
                    pass
                try:
                    common.log("BaseCursor.request",  "SQL > %s"%statement, xbmc.LOGERROR)
                except:
                    pass
                try:
                    i = 1
                    for var in binds:
                        common.log ("BaseCursor.request", "SQL request numvar = %d  content = %s"%(i,var), xbmc.LOGERROR)
                        i=i+1
                except:
                    pass
        except Exception as msg:
            try:
                common.log("BaseCursor.request",  "The request failed :", xbmc.LOGERROR )
                common.log("BaseCursor.request",  "%s - %s"%(Exception,msg), xbmc.LOGERROR )
            except:
                pass
